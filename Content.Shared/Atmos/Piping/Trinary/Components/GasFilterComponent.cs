...
/// <summary>
/// Defines a gas filter, which removes specific gases out of the input mixture, and outputs that to a secondary outlet
/// </summary>
...
public sealed partial class GasFilterComponent : Component
{
    ...
    /// <summary>
    /// Gases to filter out into the secondary outlet.
    /// </summary>
    [DataField, AutoNetworkedField]
