...
// SPDX-FileCopyrightText: 2026 TemporalOroboros <TemporalOroboros@gmail.com>
...
public abstract partial class SharedGunSystem : EntitySystem
{
    ...
    protected const float DamagePitchVariation = 0.05f;
    ...
    public bool AttemptShoot(EntityUid user, Entity<GunComponent> gun, EntityCoordinates toCoordinates, EntityUid? target = null)
    {
        ...
        var result = AttemptShoot(user, gun) != null;
    ...
    public bool AttemptShoot(Entity<GunComponent> gun)
    {
        ...
        var result = AttemptShoot(gun, gun) != null;
        gun.Comp.ShotCounter = 0;
        return result;
    }
    ...
    protected void RemoveShootable(EntityUid uid)
    {
        ...
        RemCompDeferred<HitscanAmmoComponent>(uid);
    }
...
public record struct GunShotEvent(
    ...
    EntityCoordinates ToCoordinates = default);
