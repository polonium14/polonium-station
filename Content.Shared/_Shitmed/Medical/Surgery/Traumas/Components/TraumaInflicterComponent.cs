...
{
    /// <summary>
    /// If the severity of the wound is lesser than this, the trauma won't be induced.
    /// </summary>
    [DataField, AutoNetworkedField]
    public FixedPoint2 SeverityThreshold = 9f;

    /// <summary>
    /// The container where all the traumas are stored. Null until ComponentInit runs.
    /// </summary>
    [ViewVariables(VVAccess.ReadOnly)]
    public Container? TraumaContainer;

    /// <summary>
    /// Instead of putting a '-1' in TraumasChance, just remove it from allowed traumas.
    /// </summary>
