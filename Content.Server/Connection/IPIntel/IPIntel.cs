...
public sealed class IPIntel
{
        ...
        IGameTiming gameTiming)
    {
        ...
        cfg.OnValueChanged(CCVars.GameIPIntelCacheLength, b => _cacheDays = b, true); // Polonium
        cfg.OnValueChanged(CCVars.GameIPIntelExemptPlaytime, b => _exemptPlaytime = b, true); // Polonium
