using Content.Shared._Imperial.ErtCall;
...
public sealed partial class CallErtSystem : EntitySystem
{
    ...
    public bool SpawnErt(ErtCallPresetPrototype preset)
    {
        ...
        var targetGrid = _station.GetLargestGrid((targetStation, dataComp));
