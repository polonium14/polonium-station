...
// SPDX-FileCopyrightText: 2026 eoineoineoin <github@eoinrul.es>
...
namespace Content.Client.Paper.UI
{
    ...
    public sealed partial class PaperWindow : BaseWindow
    {
        ...
        // timeout is the only signal that the save never landed. Kept well above
        // any plausible round-trip so normal latency never trips a false failure.
        ...
        public void Populate(PaperComponent.PaperBoundUserInterfaceState state)
        {
            ...
            if (!wasEditing && isEditing && SignButtons.Visible)
                EndSignaturePlacement();
