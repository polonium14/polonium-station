...
namespace Content.Client.Paper.UI
{
    ...
    public sealed partial class PaperWindow : BaseWindow
    {
        ...
        public void PopulatePaginated(PaperComponent.PaperBoundUserInterfaceState state, int currentPage, int linesPerPage)
        {
            EnablePagination(currentPage, linesPerPage);
        ...
        private void PaginateContent(string content)
        {
            ...
            else
            {
                ...
                {
                    var pageLines = lines.Skip(i).Take(_linesPerPage);
        ...
        {
            if (!_isPaginated || _pages.Count == 0)
                return;

            var pageContent = _pages[_currentPage];
            var msg = new FormattedMessage();
            msg.AddMarkupPermissive(pageContent);

            WrittenTextLabel.SetMessage(msg, _allowedTags, DefaultTextColor);
            WrittenTextLabel.Visible = pageContent.Length > 0;
            ...
            PageIndicator.Text = Loc.GetString("book-ui-page-indicator",
                ...
                ("total", _pages.Count));
            StampDisplay.Visible = _currentPage == _pages.Count - 1;
        }
        ...
        private void ChangePage(int newPage)
        {
            ...
            _entManager.System<AudioSystem>().PlayGlobal(PageTurnSound, Filter.Local(), false);
        }
    }
}
