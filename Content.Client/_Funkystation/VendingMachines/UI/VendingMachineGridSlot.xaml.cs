...
public sealed partial class VendingMachineGridSlot : PanelContainer
{
    ...
    public VendingMachineGridSlot()
    {
        ...
        SoldLabel.FontOverride = new VectorFont(_resourceCache.GetResource<FontResource>("/EngineFonts/NotoSans/NotoSans-Regular.ttf"), 10);
    }
