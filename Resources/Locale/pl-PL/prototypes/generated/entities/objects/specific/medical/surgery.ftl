...
ent-OmnimedTool = medical multitool
    .desc = A high end surgery tool that has all the needed surgery tools built in inside it, it's the end of the line for surgeons looking for better tools.
ent-OmnimedToolSyndie = { ent-OmnimedTool }
    .desc = A higher end surgery tool that has all the needed surgery tools built in inside it, it's the end of the line for evil surgeons looking for better tools. Seems to be of Interdyne make.
