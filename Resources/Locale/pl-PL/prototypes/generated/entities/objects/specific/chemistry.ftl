...
ent-SyringeCryostasis = advanced syringe
    .desc = An advanced syringe with a larger capacity that can also draw or inject faster, contain chemicals or solutions without reactions.
ent-Pill = pill
