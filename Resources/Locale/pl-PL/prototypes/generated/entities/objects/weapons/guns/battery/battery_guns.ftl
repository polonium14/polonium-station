...
ent-WeaponDisabler = disabler
    .desc = A self-defense weapon that exhausts organic targets, slowing them to a crawl.
    .suffix = DO NOT MAP
...
ent-WeaponEnergyShotgun = energy shotgun
    .desc = A one-of-a-kind prototype energy weapon with a configurable beam spread.
ent-WeaponEnergyGunMultiphase = X-01 Multiphase
    .desc = This is an expensive, modern recreation of the antique laser gun. This gun can fire both laser and ion beams and slowly recharges over time.
