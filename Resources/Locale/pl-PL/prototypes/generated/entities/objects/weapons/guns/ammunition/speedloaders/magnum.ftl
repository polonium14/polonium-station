ent-BaseSpeedLoaderMagnum = szybki ładowacz (kal. .45 magnum)
    .desc = { ent-BaseItem.desc }
ent-SpeedLoaderMagnum = szybki ładowacz (kal. .45 Magnum)
...
ent-SpeedLoaderMagnumEmpty = speed loader (.45 magnum pusty)
