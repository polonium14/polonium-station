...
ent-LauncherCreamPie = armata na kremowe ciasto
    ...
    .suffix = Puste
ent-BorgLauncherCreamPie = eksperymentalne działo ciastkowe
    .desc = Dostarcz hojną część śmietany bezpośrednio do załogi! Automatycznie upieka ciastka z upływem czasu.
