...
ent-WeaponPistolCobra = cobra
    .desc = Integrally suppressed semi-automatic pistol used by the Syndicate, firing bezłuskowe subsonic rounds. Favored by any agent who likes to keep things quiet and leave no evidence behind. Feeds from .25 pistol magazines.
