ent-BaseStationBeacon = nawigator stacji
    .desc = Małe urządzenie, które przesyła informacje do map stacji. Możliwość konfiguracji.
    .suffix = Nie jest to punkt teleportacji, a czarna lista celów ataków Ninja
ent-TeleportStationBeacon = { ent-BaseStationBeacon }
    .suffix = Czarna lista celów ataków Ninja
