...
ent-ClothingHandsGlovesCMO = CMO's surgical grade gloves
    .desc = High-quality surgical grade gloves made of nitrile and some other proprietary mixture of fabrics. The tight tolerances of the gloves make it easier to do surgery in them than normally possible with typical medical grade gloves.
...
ent-ClothingHandsGlovesRobohands = roboticist's gloves
    .desc = Tekkou-styled fingerless gloves with a fingerloop. Won't protect you from live wires, but will look GREAT doing it.
...
ent-ClothingHandsBlueGlovesJanitor = blue rubber gloves
    .desc = High-quality rubber gloves, squeaky to do some cleaning!
ent-ClothingHandsOrangeGlovesJanitor = orange rubber gloves
    .desc = High-quality rubber gloves, squeaky to do some cleaning!
ent-ClothingHandsPurpleGlovesJanitor = purple rubber gloves
    .desc = High-quality rubber gloves, squeaky to do some cleaning!
...
ent-ClothingHandsSecurityKnuckleDusters = security knuckle dusters
    .desc = Cold steel knuckle dusters, makes your punches hit much harder. These make it easier to beat up tiders.
ent-ClothingHandsTruncheonKnuckleDusters = security truncheon knuckle dusters
    .desc = Knuckle dusters made of steel and plastic, designed to ensure someone gets knocked down and stays down.
