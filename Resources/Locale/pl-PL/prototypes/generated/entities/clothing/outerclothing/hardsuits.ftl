...
ent-ClothingOuterHardsuitLuxury = quartermaster's luxury hardsuit
    .desc = A high quality custom ordered hardsuit, fashioned after the Kwatermistrz's colors.
...
ent-ClothingOuterHardsuitSyndieElite = Syndykat aramid hardsuit
    .desc = An alternative model of the blood-red hardsuit, with improved fireproofing. Property of Maruderzy Gorlex.
