...
ent-ClothingUniformJumpskirtChemistry = chemistry coverskirt
    .desc = Basic PPE for any Che- Why are you wearing A SKIRT?! THAT'S NOT SAFE AT ALL!
...
ent-ClothingUniformJumpskirtCMO = chief medical officer's coverskirt
    .desc = Sterile coveralls with markings belonging to a CMO. For when the Medbay is particularly messy - or was, before you decided to wear it with a skirt.
ent-ClothingUniformJumpskirtCMOTurtle = chief medical officer's turtleskirt
...
ent-ClothingUniformJumpskirtMedicalDoctor = medical sterile coverskirt
    .desc = Sterile coveralls meant for work in a Medbay. This pair seems to have.. a skirt? That doesn't seem very sterile...
...
ent-ClothingUniformJumpskirtRoboticist = roboticist's sleeveless interfacing suit
    .desc = It's a slimming black with reinforced neuro-connectors; with a waist-tied lab coat and no sleeves, for maximum fashion.
