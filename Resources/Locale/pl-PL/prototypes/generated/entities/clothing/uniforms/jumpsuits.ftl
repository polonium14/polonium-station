...
ent-ClothingUniformJumpsuitClown = clown suit
    .desc = HONK!
ent-ClothingUniformJumpsuitClownAlt = clown jumpsuit
    .desc = HONK!
ent-ClothingUniformJumpsuitPolkadotClown = polka dot jumpsuit
    .desc = a colerfull polka dot suit! smells oddly like meat from a meat clown
