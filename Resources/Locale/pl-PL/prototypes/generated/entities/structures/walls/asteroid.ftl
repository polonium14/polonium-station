...
ent-IronSandstone = żelazo, piasek i kamień
    .suffix = brak wydobycia rudy
    .desc = { ent-AsteroidRock.desc }
ent-IronSandstoneMining = żelazo, piasek i kamień
    .suffix = wyższa wydajność wydobycia rudy
