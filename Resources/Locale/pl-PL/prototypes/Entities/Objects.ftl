...
ent-SnowBattlemap = snow battlemap
    .desc = A battlemap for your frigid exploring to begin, pieces not included! # if this isn't funny enough i can remove it
...
ent-ModularReceiver = modular receiver
    .desc = A vital part used in the creation of firearms. #Could use a better description, but I'm not a gun nut so I can't really do that.
ent-RifleStock = rifle stock
    .desc = A robust wooden stock, used in the creation of firearms. #Same as above
...
ent-SpeedLoaderMagnumEmpty = speed loader (.45 magnum any)
    .desc = Designed to quickly refill an empty revolver, it fits up to six rounds for the big iron on your hip. #Big Iron reference (duh)
