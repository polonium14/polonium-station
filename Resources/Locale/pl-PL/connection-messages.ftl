...
cmd-whitelistadd-arg-player = [gracz]
...
cmd-whitelistremove-arg-player = [gracz]
...
ban-expires = Ten ban skończy się za { $duration } minut lub o/w { $time } w systemie UTC.
ban-banned-1 = Ty lub inny użytkownik tego komputera lub łącza został zbanowany z rozgrywki.
ban-banned-2 = Powód bana: "{ $reason }"
ban-banned-3 = Próby ominięcia tego bana, takie jak utworzenie nowego konta, będą rejestrowane.
