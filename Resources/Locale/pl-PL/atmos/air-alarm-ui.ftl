...
air-alarm-ui-pressure-bound-nobound = Brak powiązania
air-alarm-ui-pressure-bound-internalbound = Wewnętrzne powiązanie
air-alarm-ui-pressure-bound-externalbound = Zewnętrzne powiązanie
air-alarm-ui-pressure-bound-both = Obydwa
...
air-alarm-ui-scrubber-wide-net-label = SzerokaSieć
