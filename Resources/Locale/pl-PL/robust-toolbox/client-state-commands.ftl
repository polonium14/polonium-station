...
cmd-reset-ent-help = Użycie: { $command } <Entity UID>
...
cmd-reset-all-ents-help = Użycie: { $command }
...
cmd-detach-ent-help = Użycie: { $command } <Entity UID>
cmd-detach-ent-desc = Odłącza jednostkę do "null-space", tak jakby opuściła zasięg PVS.
cmd-local-delete-help = Użycie: { $command } <Entity UID>
...
cmd-full-state-reset-help = Użycie: { $command }
