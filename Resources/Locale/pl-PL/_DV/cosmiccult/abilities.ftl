...
cosmicability-siphon-cultist-success = Your attempts to draw entropy chill { CAPITALIZE($target) }
cosmicability-siphon-success = You silently draw Entropy from { CAPITALIZE($target) }.
cosmicability-siphon-fail = You can't seem to siphon Entropy from { CAPITALIZE($target) }.
cosmicability-siphon-full = You can't hold any more Entropy!
cosmicability-blank-begin = { CAPITALIZE($target) } attempts to grab hold of you!
cosmicability-blank-success = You shunt { CAPITALIZE($target) }'s mind unto the cosmic dark.
...
cosmicability-lapse-success = You lapse { CAPITALIZE($target) }'s corporeal form.
