...
cmd-cultify-failure-no-entity = Nie znaleziono prawidłowej encji.
cmd-cultify-failure-no-mind = Nie znaleziono prawidłowego umysłu.
cmd-cultify-failure-not-borg = Encja nie jest borgiem!
