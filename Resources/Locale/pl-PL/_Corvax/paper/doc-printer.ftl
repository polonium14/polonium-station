...
doc-text-printer-ntr-penalty-category-elevation-request = [color=#7a5c1a][mono]█▄ █ ▀█▀[/mono]    [head=2]Wniosek o podwyższenie[/head][/color]
    ...
    {"             [head=3]Sektor: :STACJA: | PNT-KAR[/head]"}
    {"==============================================="}
    {"[bold]Data:[/bold] :DATA:"}
    {"[bold]Autor dokumentu:[/bold] :IMIĘ_NAZWISKO:"}
    {"[bold]Stanowisko:[/bold] Przedstawiciel Nanotrasen"}
    {"==============================================="}
    {"Ja, :IMIĘ_NAZWISKO:, w charakterze Przedstawiciela Nanotrasen, niniejszym wnoszę do Centralnego Dowództwa o podwyższenie dopuszczalnych kategorii karnych w toku postępowania dyscyplinarnego."}
