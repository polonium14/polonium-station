...
cargo-pallet-console-menu-title = Logistyczna konsola sprzedarzy
cargo-pallet-menu-appraisal-label = Estymowana wartość:{ " " }
...
cargo-pallet-menu-no-goods-text = Wycena...
