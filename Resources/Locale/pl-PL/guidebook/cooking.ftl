guidebook-microwave-ingredients-header = Składniki
guidebook-microwave-cook-time-header = Czas smażenia/gotowania
guidebook-microwave-cook-time =
    { $time ->
        [0] Natychmiastowo
        [few] [bold]{ $time }[/bold] sekundy
       *[many] [bold]{ $time }[/bold] sekund
    }
