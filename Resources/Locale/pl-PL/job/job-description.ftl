...
job-description-qm = Zarządzaj dostawami stacji i całym departamentem logistyki, trzymaj oko na utylizatorów aby pracowali i upewniaj się że wszystkie zamówienia są wykonane, trzymaj pieniądze w obiegu.
...
job-description-salvagespec = Używaj magnesu utylizacyjnego do zaciągania odczepionych szczątek, asteroid do utylizacji wzbogacając stację. Zbuduj statek utylizacyjny i podróżuj na inne planety, po drodze walcząc z nieprzyjazną fauną.
