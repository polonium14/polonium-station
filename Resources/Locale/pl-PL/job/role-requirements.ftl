...
role-timer-age-too-old = Twoja postać musi być młodsza niż [color=yellow]{ $age }[/color] lat abyś mógł to wybrać.
role-timer-age-too-young = Twoja postać musi być starsza niż [color=yellow]{ $age }[/color] lat abyś mógł to wybrać.
...
role-timer-locked = Zablokowane (najedź po szczegóły)
role-timer-department-unknown = Nieznany dział
