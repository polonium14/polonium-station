...
job-name-hos = Komendant Ochrony
...
job-name-cmo = Ordynator Medyczny
...
JobChef = Kucharz
JobChemist = Chemik
JobChiefEngineer = Naczelny Inżynier
JobChiefMedicalOfficer = Ordynator Medyczny
JobClown = Klaun
...
JobHeadOfSecurity = Komendant Ochrony
