...
job-name-engineer = Technik Stacji
job-name-atmostech = Technik Środowiskowy
job-name-hop = Kierownik Kadrowy
...
JobHeadOfPersonnel = Kierownik ds. Kadrowych
