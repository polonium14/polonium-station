...
thaven-mood-dont-speak-to-command-desc = Jesteś zbyt nisko postawiony, by odzywać się do dowództwa, nawet jeśli odezwie się pierwszę.
...
thaven-mood-dinner-floor-name = Etykieta Jadalna
...
thaven-mood-afraiddark-desc = W ciemności kryje sie wiele niebezpieczenśtw, i nie wkroczysz w nią bez odpowiedniego oświetlenia.
