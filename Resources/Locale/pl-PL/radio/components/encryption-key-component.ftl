encryption-key-successfully-installed = Wkładasz kartę szyfrowania.
encryption-key-slots-already-full = Nie ma miejsca dla kolejnej karty szyfrowania.
encryption-keys-all-extracted = Wyjmuszesz wszystkie karty szyfrowania!
encryption-keys-no-keys = To urządzenie nie ma kart szyfrowania!
