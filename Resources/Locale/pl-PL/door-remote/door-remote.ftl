...
door-remote-toggle-eletrify-text = Przełącz przeciążenie
...
door-remote-invalid-text = Niepoprawne
door-remote-mode-label = Tryb: [color=white]{ $modeString }[/color]

## Entity

door-remote-switch-state-open-close = Przełączasz pilot do otwieriania i zamykania drzwi
door-remote-switch-state-toggle-bolts = Przełączasz pilot do przełączania bolców
