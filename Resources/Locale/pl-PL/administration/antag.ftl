verb-categories-antag = Kontrola Antaga
admin-verb-make-traitor = Zamień cel w zdrajcę.
admin-verb-make-initial-infected = Zamień cel w Początkowo Zainfekowanego.
admin-verb-make-zombie = Natychmiast zamienia cel w zombie.
admin-verb-make-nuclear-operative = Zamień cel w samotnego Nuklearnego Agenta.
admin-verb-make-pirate = Zamień cel w pirata. Uwaga: nie zmienia zasad gry.
...
admin-verb-text-make-nuclear-operative = Zrób Nuklearnego Agenta
admin-verb-text-make-pirate = Zrób Pirata
