...
admin-entity-search-filter = Filtr gridów
admin-entity-search-grid-toggle = Filtruj po gridzie
admin-entity-search-grid-placeholder = ID gridów oddzielone przecinkami
