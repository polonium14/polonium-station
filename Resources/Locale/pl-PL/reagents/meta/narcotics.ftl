...
reagent-name-tacitic-acid = kwas tolinowy
reagent-desc-tacitic-acid = Czynnik paraliżujący skierowany do krtani, uniemożliwiający użytkownikowi mowę. Ze względu na efekt drętwienia, cel nie jest świadomy dopóki nie spróbują zabrać głosu.
...
reagent-name-Hydroxysomnolene = Hydroksysomnolen
reagent-desc-Hydroxysomnolene = Produkt uboczny metylenodioksystrakinonu (alias Strawberry Ice), gdy jest on metabolizowany. Wiąże się z nowo uwolnionymi neuroreceptorami w mózgu po przepłukaniu metylenodioksystrachinonu z układu, powodując spowolnienie i senność. Jedynymi sposobami zmniejszenia efektów jest albo poczekanie na nie, albo zbierz kolejne uderzenie tej truskawki...
reagent-name-StrawberryIce = Metylenodioksystrakinon
reagent-desc-StrawberryIce = Specjalny lek zaprojektowany tak, aby był nawet silniejszy od Desoksyfedryny. Znany jako „Lód truskawkowy” lub „Lód dziewczyny” ze względu na swój kolor i smak, jest niezwykle uzależniony i wywołuje silne objawy odstawienne. Podczas gdy wysoka wysokość jest wyższa, a użytkownicy zgłaszają loty przez deszcz, podczas gdy znajdują się pod jej wpływem, bliskie wieczne okrucieństwa czekają na tych, którzy przestają je zużywać.
