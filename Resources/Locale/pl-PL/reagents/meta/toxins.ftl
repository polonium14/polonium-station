reagent-name-toxin = toksyny
reagent-desc-toxin = Niespodziewanie toksyczna substancja. Dostępna w zhakowanych dystrybutorach chemikaliów.
reagent-name-carpotoxin = karpotoksyna
reagent-desc-carpotoxin = Wysoce toksyczny odczynnik obecny w kosmicznych karpiach. Powoduje bolesne uczucie palenia.
reagent-name-mold = pleśń
reagent-desc-mold = Grzyb, znajdowany w ciemnych, wilkotnych miejscach lub na przeterminowanym chlebie. Powoduje rozwój choroby po sporzyciu.
reagent-name-polytrinic-acid = kwas politryniczny
reagent-desc-polytrinic-acid = Wysoce korodująca substancja chemiczna. Poważnie parzy wszystkich którzy wejdą z nią w kontakt.
reagent-name-chloral-hydrate = wodorotlenek chloru
reagent-desc-chloral-hydrate = Usypiająca i hiptotyzująca substancja. Najczęściej używana aby usypiać osoby, czy tego chcą czy nie.
reagent-name-gastrotoxin = gastrotoksyna
reagent-desc-gastrotoxin = W miarę toksyczny produkt uboczny rozkładu. Najczęściej spotykana w przeterminowanym jedzeniu.
