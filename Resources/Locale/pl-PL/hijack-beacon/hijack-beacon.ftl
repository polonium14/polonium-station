hijack-beacon-announcement-sender = Automatyczna Stacja Handlowa
...
hijack-beacon-announcement-deactivated = Naruszenie zapory nie powiodło się. Integralność zapory została częściowo przywrócona. Miłego dnia!
...
hijack-beacon-verb-activate-text = Aktywuj
hijack-beacon-verb-activate-message = The beacon can only be armed on the Automated Trade Station, on an unoccupied tile.
hijack-beacon-verb-deactivate-text = Dezaktywuj
hijack-beacon-verb-deactivate-message = Pławnica nie ma zamiaru dezaktywować samego siebie, wiesz o tym.
