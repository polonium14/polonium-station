...
comms-console-change-alert-level-button = Zmień status
comms-console-confirm-alert-level-button = Potwierdź
...
comms-console-station-announcements-header = Ogłoszenia stacji
