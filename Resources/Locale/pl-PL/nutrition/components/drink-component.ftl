drink-component-on-use-is-empty = { CAPITALIZE($owner) } is empty!
...
drink-component-try-use-drink-is-empty = { CAPITALIZE($entity) } is empty!
...
drink-component-force-feed = { CAPITALIZE($user) } is trying to make you drink something!
drink-component-force-feed-success = { CAPITALIZE($user) } forced you to drink something! { $flavors }
