...
food-system-try-use-food-is-empty = { CAPITALIZE($entity) } is empty!
food-system-wrong-utensil = You can't eat { $food } with { INDEFINITE($utensil) } { $utensil }.
food-system-cant-digest = You can't digest { $entity }!
food-system-cant-digest-other = { CAPITALIZE(SUBJECT($target)) } can't digest { $entity }!
food-system-verb-eat = Eat

## Force feeding

food-system-force-feed = { CAPITALIZE($user) } is trying to feed you something!
food-system-force-feed-success = { CAPITALIZE($user) } forced you to eat something! { $flavors }
