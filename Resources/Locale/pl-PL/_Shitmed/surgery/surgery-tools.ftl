...
surgery-tool-name-bone-gel =
    { $przypadek ->
        [dopelniacz] żelu kostnego
        [biernik] żel kostny
       *[mianownik] żel kostny
    }
surgery-tool-name-bone-saw =
    { $przypadek ->
        [dopelniacz] piły do kości
       *[mianownik] piła do kości
    }
surgery-tool-name-bone-setter =
    { $przypadek ->
        [dopelniacz] nastawiacza kości
       *[mianownik] nastawiacz kości
    }
surgery-tool-name-cautery =
    { $przypadek ->
        [dopelniacz] kautera
       *[mianownik] kauter
    }
surgery-tool-name-drill =
    { $przypadek ->
        [dopelniacz] wiertła
       *[mianownik] wiertło
    }
surgery-tool-name-hemostat =
    { $przypadek ->
        [dopelniacz] hemostatu
       *[mianownik] hemostat
    }
surgery-tool-name-retractor =
    { $przypadek ->
        [dopelniacz] rozwórki
       *[mianownik] rozwórka
    }
surgery-tool-name-scalpel =
    { $przypadek ->
        [dopelniacz] skalpela
        [narzednik] skalpelem
       *[mianownik] skalpel
    }
surgery-tool-name-stitches =
    { $przypadek ->
        [dopelniacz] nici chirurgicznych
       *[mianownik] nici chirurgiczne
    }
surgery-tool-name-tending =
    { $przypadek ->
        [dopelniacz] opatrunku
       *[mianownik] opatrunek
    }
surgery-tool-name-tweezers =
    { $przypadek ->
        [dopelniacz] pęsety
       *[mianownik] pęseta
    }
surgery-tool-name-organ =
    { $przypadek ->
        [dopelniacz] organu
       *[mianownik] organ
    }
