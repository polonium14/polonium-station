plant-analyzer-component-no-seed = Brak Ro┼Ыliny
...
plant-analyzer-component-nutrition = Od┼╝ywienie:
plant-analyzer-component-toxins = Toksyny:
plant-analyzer-component-pests = Szkodniki:
plant-analyzer-component-weeds = Chwasty:
plant-analyzer-component-alive = [color=green]┼╗YWE[color]
plant-analyzer-component-dead = [color=red]MARTWE[color]
plant-analyzer-component-unviable = [color=red]NIEZDATNE[color]
plant-analyzer-component-mutating = [color=#00ff5f]MUTUJ─ДCE[color]
plant-analyzer-component-kudzu = [color=red]KUDZU[color]
plant-analyzer-soil = Niewch┼Вoni─Щte Reagenty: [color=white]{ $chemicals }[/color]
plant-analyzer-soil-empty = Niewch┼Вoni─Щte Reagenty: [color=gray]Brak[/color]
plant-analyzer-component-environment = [bold]Analiza Optymalnych Warunk├│w[/bold] { $nl }
plant-analyzer-component-light = Poziom Na┼Ыwietlenia: [color=white]{ $lightLevel } ┬▒ { $lightTolerance }[/color]{ $nl }
plant-analyzer-component-temperature = Temperatura: [color=lightsalmon]{ $temp }┬░k ┬▒ { $tempTolerance }┬░k[/color]{ $nl }
plant-analyzer-component-pressure = Ci┼Ыnienie: [color=lightblue]{ $kpa }kPa ┬▒ { $kpaTolerance }kPa[/color]{ $nl }
...
plant-analyzer-produce-title = [bold]Analiza Plonu Ro┼Ыliny[/bold] { $nl }
...
plant-analyzer-potency-small = Ma┼Вa
plant-analyzer-potency-medium = ┼Ъrednia
plant-analyzer-potency-large = Du┼╝a
...
plant-analyzer-printout = [color=#9FED58][head=2]Raport Analizatora Ro┼Ыlin[/head][/color]{ $nl }тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА{ $nl }[bullet/] Gatunek: { $seedName }{ $nl }{ $indent }[bullet/] Zdatne: { $viable ->
       ...
       *[other] { LOC("plant-analyzer-printout-missing") }
    }{ $nl }{ $indent }[bullet/] Wytrzyma┼Вo┼Ы─З: { $endurance }{ $nl }{ $indent }[bullet/] D┼Вugo┼Ы─З ┼╝ycia: { $lifespan }{ $nl }{ $indent }[bullet/] Owoc: { $yield ->
