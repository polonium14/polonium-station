...
ui-options-highlight-sound = Play a sound when a highlight is matched
ui-options-highlight-volume = Highlight ping volume
...
ui-options-hotkey-toggle-sprint = Toggle Sprint
