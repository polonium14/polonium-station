...
lathe-menu-delete-fabricating-tooltip = Anuluj drukowanie bieżącego elementu.
lathe-menu-delete-item-tooltip = Anuluj drukowanie tej partii.
lathe-menu-move-up-tooltip = Przenieś tę partię przed kolejkę.
lathe-menu-move-down-tooltip = Przenieś tę partię za kolejkę.
