...
magic-mirror-add-slot-target = { $user } dodaje ci włosy.
magic-mirror-remove-slot-target = { $user } ścina ci włosy.
magic-mirror-change-slot-target = { $user } zmienia twoją fryzurę.
