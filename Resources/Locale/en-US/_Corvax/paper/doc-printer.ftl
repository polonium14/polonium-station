doc-text-printer-report-station = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Raport o sytuacji na stacji[/head][/color]
    {"[color=#1b67a5]█ ▀█   █     [head=3]Sector: :STATION: | DOW-CD[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Bieżący kod zagrożenia:[/bold]"}
    {"- [bold]Aktywne zagrożenia na stacji:[/bold]"}
    {"- [bold]Ogólny stan stacji:[/bold]"}
    {"- [bold]Efektywność i stan działu Ochrony:[/bold]"}
    {"- [bold]Efektywność i stan działu Medycznego:[/bold]"}
    {"- [bold]Integralność systemów technicznych:[/bold]"}
    {"- [bold]Uwagi dodatkowe*:[/bold]"}
    {"* - pole opcjonalne."}
    {"▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄"}
    {"▄▄  ▄▄   ▄▄▄▄     ▄▄▄▄▄▄         ▄▄"}
    {"[italic]Stamp here:[/italic]"}
doc-text-printer-ert-request = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Żądanie wysłania[/head][/color]
    ...
    {"             [head=3]Sector: :STATION: | XXX-CD[/head]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"Niniejszym przedkładam oficjalne żądanie natychmiastowej interwencji Jednostki Szybkiego Reagowania."}
    {"- [bold]Uzasadnienie wezwania:[/bold]"}
    {"- [bold]Ogólny stan stacji:[/bold]"}
    {"- [bold]Efektywność i stan działu Ochrony:[/bold]"}
...
doc-text-printer-resignation = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Wypowiedzenie umowy o pracę[/head][/color]
    {"[color=#1b67a5]█ ▀█   █     [head=3]Sector: :STATION: | XXX-DOW[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
...
doc-text-printer-job-change-request = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Wniosek o zmianę stanowiska[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"Proszę o rozpatrzenie mojej kandydatury na stanowisko :JOB: w dziale <Wprowadź dział>."}
...
doc-text-printer-access-extension = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Wniosek o rozszerzenie dostępu[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Żądane dodatkowe dostępy:[/bold]"}
...
doc-text-printer-id-card-request = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Wniosek o wydanie karty identyfikacyjnej[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"Proszę o wydanie nowej karty identyfikacyjnej."}
    {"- [bold]Powód wydania:[/bold]"}
...
doc-text-printer-removal-order = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Nakaz usunięcia ze stanowiska[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"Niniejszym nakazuję natychmiastowe odsunięcie <Imię i nazwisko pracownika> od pełnienia obowiązków na stanowisku :JOB: w dziale <Wprowadź dział>."}
...
doc-text-printer-interim-captain-request = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Wniosek o powołanie[/head][/color]
    ...
    {"             [head=3]Sector: :STATION: | DOW-CD[/head]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"Niniejszym wnioskuję o powołanie mnie na stanowisko Tymczasowego Kapitana Stacji w związku z brakiem osoby pełniącej tę funkcję."}
    {"- [bold]Opis bieżącej sytuacji:[/bold]"}
...
doc-text-printer-heads-council-protocol = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Protokół ze spotkania[/head][/color]
    ...
    {"             [head=3]Sector: :STATION: | DOW-DOW[/head]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Powód zwołania spotkania:[/bold]"}
    {"- [bold]Postawione pytanie:[/bold]"}
    {"[bold]Głosowanie «za»:[/bold] ___ | [bold]«przeciw»:[/bold] ___ | [bold]wstrzymujących się:[/bold] ___"}
    {"[bold]Lista głosujących «za»:[/bold]"}
...
doc-text-printer-department-activity-report = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Raport działalności działu[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Nazwa działu:[/bold]"}
    {"- [bold]Liczba aktywnych pracowników:[/bold]"}
    {"- [bold]Liczba stażystów:[/bold]"}
    {"- [bold]Pracownicy nieobecni (imię, stanowisko, powód):[/bold]"}
...
doc-text-printer-order-completion-report = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Raport z wykonania zlecenia[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"Składam raport z wykonania zlecenia otrzymanego od <stanowisko / imię i nazwisko>."}
    {"- [bold]Treść otrzymanego zlecenia:[/bold]"}
...
doc-text-printer-position-creation-request = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Wniosek o utworzenie[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Proponowana nazwa stanowiska:[/bold]"}
    {"- [bold]Opis obowiązków:[/bold]"}
...
doc-text-printer-employee-commendation-request = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Wniosek o wyróżnienie pracownika[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Imię i nazwisko wyróżnianego:[/bold]"}
    {"- [bold]Position:[/bold]"}
    {"- [bold]Dział:[/bold]"}
...
doc-text-printer-station-employment-request = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Wniosek o zatrudnienie na stacji[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"Proszę o przyjęcie mnie do działu <Wprowadź dział> na stanowisko :JOB:."}
...
doc-text-printer-access-revocation-order = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Nakaz odebrania dostępów[/head][/color]
    {"[color=#1b67a5]█ ▀█   █     [head=3]Sector: :STATION: | DOW-XXX[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"Niniejszym nakazuję natychmiastowe odebranie następujących dostępów pracownikowi <Imię i nazwisko> (<Stanowisko>):"}
    {"1."}
    {"2."}
    {"3."}
...
doc-text-printer-command-decree = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Dekret dowódczy[/head][/color]
    {"[color=#1b67a5]█ ▀█   █     [head=3]Sector: :STATION: | DOW-DOW[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"[bold]TREŚĆ DEKRETU:[/bold]"}
    {"<Wprowadź treść rozkazu obowiązującego na terenie stacji>"}
    {"[bold]Decyzja posiada rygor natychmiastowej wykonalności[/bold] dla wszystkich wymienionych poniżej działów:"}
    {"- [ ] Dowództwo"}
    {"- [ ] Dział Ochrony"}
    {"- [ ] Dział Medyczny"}
    {"- [ ] Dział Logistyczny"}
...
doc-text-printer-station-goal-progress-report = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Raport z realizacji celu stacji[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Opis celu stacji:[/bold]"}
    {"- [bold]Stopień realizacji:[/bold] ___%"}
    {"- [bold]Wykonane działania:[/bold]"}
...
doc-text-printer-restricted-equipment-permit = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Zezwolenie na sprzęt ograniczony[/head][/color]
    {"[color=#1b67a5]█ ▀█   █     [head=3]Sector: :STATION: | XXX-OCH[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Nazwa odbiorcy:[/bold]"}
    {"- [bold]Uzasadnienie zezwolenia:[/bold]"}
    {"- [bold]Wydany sprzęt:[/bold]"}
...
doc-text-printer-interrogation-protocol = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Protokół przesłuchania[/head][/color]
    {"[color=#1b67a5]█ ▀█   █     [head=3]Sector: :STATION: | OCH-DOW[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Tożsamość przesłuchiwanego:[/bold]"}
    {"- [bold]Stanowisko przesłuchiwanego:[/bold]"}
    {"- [bold]Pracownik przeprowadzający przesłuchanie:[/bold]"}
    {"- [bold]Stanowisko przeprowadzającego przesłuchanie:[/bold]"}
    {"- [bold]Obecni świadkowie:[/bold]"}
    {"W trakcie wstępnego śledztwa i późniejszego przesłuchania znaleziono dowody wskazujące na popełnienie przestępstwa przez tę osobę."}
    {"- [bold]Naruszone artykuły Prawa Kosmicznego:[/bold]"}
...
doc-text-printer-execution-order = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Nakaz egzekucji[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Tożsamość skazanego:[/bold]"}
    {"- [bold]Uzasadnienie egzekucji:[/bold]"}
    {"- [bold]Kwalifikacja prawna (artykuły PK):[/bold]"}
    {"- [bold]Wybrana metoda terminacji:[/bold]"}
...
doc-text-printer-investigation-report = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Raport z dochodzenia[/head][/color]
    {"[color=#1b67a5]█ ▀█   █     [head=3]Sector: :STATION: | DET-OCH[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"[bold]I. OPIS INCYDENTU:[/bold]"}
    {"[bold]II. ZEBRANE DOWODY:[/bold]"}
    {"1. Logi systemowe:"}
    {"2. Analiza DNA / Biometrii:"}
    {"3. Zabezpieczone przedmioty:"}
    {"4. Zeznania świadków:"}
    {"5. Inne:"}
...
doc-text-printer-witness-testimony = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Zeznanie świadka[/head][/color]
    {"[color=#1b67a5]█ ▀█   █     [head=3]Sector: :STATION: | OCH-OCH[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Tożsamość świadka:[/bold]"}
    {"- [bold]Stanowisko świadka:[/bold]"}
    {"- [bold]Miejsce zdarzenia:[/bold]"}
    {"- [bold]Czas zdarzenia (od początku zmiany):[/bold]"}
...
doc-text-printer-arrest-request = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Wniosek o zatrzymanie[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Tożsamość podejrzanego:[/bold]"}
    {"- [bold]Stanowisko podejrzanego:[/bold]"}
    {"- [bold]Naruszone artykuły Prawa Kosmicznego:[/bold]"}
...
doc-text-printer-detained-persons-register = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Rejestr osób zatrzymanych w ciągu zmiany[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"| Lp. | Imię i nazwisko | Stanowisko | Powód zatrzymania | Czas trwania | Status |"}
    {"|-----|-----------------|------------|-------------------|--------------|--------|"}
    {"| 1   |                 |            |                   |              |        |"}
    {"| 2   |                 |            |                   |              |        |"}
...
doc-text-printer-room-search-protocol = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Protokół przeszukania pomieszczenia[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Lokalizacja przeszukiwana:[/bold]"}
    {"- [bold]Powód przeszukania:[/bold]"}
    {"- [bold]Obecni funkcjonariusze:[/bold]"}
    {"- [bold]Znalezione przedmioty:[/bold]"}
    {"1."}
    {"2."}
...
doc-text-printer-asset-seizure-order = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Nakaz konfiskaty mienia[/head][/color]
    {"[color=#1b67a5]█ ▀█   █     [head=3]Sector: :STATION: | OCH-XXX[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Właściciel mienia:[/bold]"}
    {"- [bold]Uzasadnienie konfiskaty:[/bold]"}
    {"[bold]Lista konfiskowanych przedmiotów:[/bold]"}
...
doc-text-printer-patrol-report = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Raport z patrolu[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Obszar patrolu:[/bold]"}
    {"- [bold]Czas trwania patrolu:[/bold]"}
    {"- [bold]Skład patrolu:[/bold]"}
...
doc-text-printer-disciplinary-sentence = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Wyrok dyscyplinarny[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"Wobec <Imię i nazwisko>, <Stanowisko>, orzekam:"}
    {"- [bold]Naruszone artykuły Prawa Kosmicznego:[/bold]"}
    {"- [bold]Kara penitencjarna:[/bold] ___ minut / dożywocie / egzekucja"}
...
doc-text-printer-arrest-extension-request = [color=#1b67a5]█▄ █ ▀█▀    [head=2]Wniosek o przedłużenie aresztu[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Tożsamość aresztowanego:[/bold]"}
...
doc-text-printer-death-certificate = [color=#50afbf]█▄ █ ▀█▀    [head=2]Akt zgonu[/head][/color]
    {"[color=#50afbf]█ ▀█   █     [head=3]Sector: :STATION: | MED-XXX[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
...
doc-text-printer-medication-order = [color=#50afbf]█▄ █ ▀█▀    [head=2]Zamówienie leków[/head][/color]
    {"[color=#50afbf]█ ▀█   █     [head=3]Sector: :STATION: | XXX-MED[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"Proszę o dostarczenie następujących leków i (lub) materiałów medycznych:"}
...
doc-text-printer-health-certificate = [color=#50afbf]█▄ █ ▀█▀    [head=2]Zaświadczenie o stanie zdrowia[/head][/color]
    ...
    {"==============================================="}
    {"[bold]- Tożsamość pacjenta:[/bold]"}
    {"[bold]- Stanowisko pacjenta:[/bold]"}
    {"[bold]- Diagnoza lekarska:[/bold]"}
    {"[bold]- Ogólny stan zdrowia pacjenta:[/bold]"}
    {"[bold]- Anamneza psychiczna:[/bold]"}
    {"[bold]- Pacjent może posiadać broń służbową:[/bold] TAK/NIE (Usuń niewłaściwe)"}
    {"[bold]- Pacjent jest zdolny do pracy z niebezpiecznymi obiektami:[/bold] TAK/NIE (Usuń niewłaściwe)"}
...
doc-text-printer-epidemiology-report = [color=#50afbf]█▄ █ ▀█▀    [head=2]Raport epidemiologiczny[/head][/color]
    {"[color=#50afbf]█ ▀█   █     [head=3]Sector: :STATION: | MED-DOW[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Zidentyfikowany patogen / zagrożenie:[/bold]"}
    {"- [bold]Liczba zakażonych:[/bold]"}
...
doc-text-printer-drug-synthesis-request = [color=#50afbf]█▄ █ ▀█▀    [head=2]Wniosek o syntezę leków[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"Proszę o przygotowanie następujących preparatów:"}
    {"1. Nazwa preparatu — Ilość / dawka"}
    {"2. Nazwa preparatu — Ilość / dawka"}
...
doc-text-printer-patient-medical-card = [color=#50afbf]█▄ █ ▀█▀    [head=2]Karta medyczna pacjenta[/head][/color]
    {"[color=#50afbf]█ ▀█   █     [head=3]Sector: :STATION: | MED-MED[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Tożsamość pacjenta:[/bold]"}
    {"- [bold]Grupa krwi / typ DNA:[/bold]"}
    {"- [bold]Historia urazów w bieżącej zmianie:[/bold]"}
...
doc-text-printer-psychological-intervention-protocol = [color=#50afbf]█▄ █ ▀█▀    [head=2]Protokół interwencji psychologicznej[/head][/color]
    ...
    {"==============================================="}
    {"- [bold]Tożsamość pacjenta:[/bold]"}
    {"- [bold]Powód interwencji:[/bold]"}
    {"- [bold]Obserwowane objawy:[/bold]"}
...
doc-text-printer-quarantine-certificate = [color=#50afbf]█▄ █ ▀█▀    [head=2]Zaświadczenie o kwarantannie[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Tożsamość objętej kwarantanną:[/bold]"}
    {"- [bold]Powód izolacji:[/bold]"}
    {"- [bold]Przewidywany czas trwania:[/bold]"}
...
doc-text-printer-cargo-order = [color=#6e502b]█▄ █ ▀█▀    [head=2]Zamówienie[/head][/color]
    {"[color=#6e502b]█ ▀█   █     [head=3]Sector: :STATION: | XXX-LOG[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"[bold]- Lista zamawianych przedmiotów:[/bold]"}
    {"1. Nazwa przedmiotu - Ilość"}
    {"2. Nazwa przedmiotu - Ilość"}
    {"[bold]- Cel zamówienia:[/bold]"}
...
doc-text-printer-disposal-report = [color=#6e502b]█▄ █ ▀█▀    [head=2]Raport z likwidacji[/head][/color]
    {"[color=#6e502b]█ ▀█   █     [head=3]Sector: :STATION: | LOG-XXX[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"Dział Logistyki przeprowadził utylizację mienia metodą: [Metoda likwidacji]. W toku działań zabezpieczono wartościowe przedmioty przekazane do właściwych departamentów."}
    {"Wykaz zabezpieczonego mienia:"}
    {"1."}
    {"2."}
    {"3."}
    {"▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄"}
...
doc-text-printer-delivery-receipt = [color=#6e502b]█▄ █ ▀█▀    [head=2]Potwierdzenie odbioru dostawy[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Numer zamówienia / faktury:[/bold]"}
    {"- [bold]Dostawca:[/bold]"}
    {"- [bold]Odbiorca (dział):[/bold]"}
    {"[bold]Odebrane pozycje:[/bold]"}
    {"1. Nazwa — Ilość — Stan"}
    {"2. Nazwa — Ilość — Stan"}
...
doc-text-printer-funds-request = [color=#6e502b]█▄ █ ▀█▀    [head=2]Wniosek o środki finansowe[/head][/color]
    {"[color=#6e502b]█ ▀█   █     [head=3]Sector: :STATION: | LOG-DOW[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Kwota wnioskowana:[/bold] ___ kredytów"}
    {"- [bold]Cel wydatku:[/bold]"}
    {"- [bold]Szczegółowy plan wykorzystania:[/bold]"}
    {"1."}
    {"2."}
...
doc-text-printer-warehouse-report = [color=#6e502b]█▄ █ ▀█▀    [head=2]Raport magazynowy działu logistycznego[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Stan konta działu:[/bold]"}
    {"- [bold]Zrealizowane zamówienia (liczba):[/bold]"}
...
doc-text-printer-construction-permit = [color=#665f1f]█▄ █ ▀█▀    [head=2]Zezwolenie na budowę[/head][/color]
    {"[color=#665f1f]█ ▀█   █     [head=3]Sector: :STATION: | INŻ-XXX[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"[bold]- Tożsamość wnioskodawcy:[/bold]"}
...
doc-text-printer-renovation-request = [color=#665f1f]█▄ █ ▀█▀    [head=2]Wniosek o prace remontowe[/head][/color]
    {"[color=#665f1f]█ ▀█   █     [head=3]Sector: :STATION: | INŻ-DOW[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    ...
    {"- [bold]Opis uszkodzeń / problemu:[/bold]"}
...
doc-text-printer-technical-work-report = [color=#665f1f]█▄ █ ▀█▀    [head=2]Raport z prac technicznych[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Zleceniodawca:[/bold]"}
    {"- [bold]Wykonane prace:[/bold]"}
...
doc-text-printer-power-status-report = [color=#665f1f]█▄ █ ▀█▀    [head=2]Raport stanu zasilania stacji[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Aktywne źródła energii:[/bold]"}
    {"- [bold]Szacowana rezerwa mocy:[/bold]"}
...
doc-text-printer-atmos-status-report = [color=#665f1f]█▄ █ ▀█▀    [head=2]Raport systemu atmosferycznego[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Ciśnienie nominalne utrzymywane:[/bold] TAK/NIE"}
    {"- [bold]Strefy z utratą szczelności:[/bold]"}
...
doc-text-printer-demolition-permit = [color=#665f1f]█▄ █ ▀█▀    [head=2]Zezwolenie na demontaż konstrukcji[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Wnioskodawca:[/bold]"}
    {"- [bold]Lokalizacja demontażu:[/bold]"}
...
doc-text-printer-sentience-certificate = [color=#665f1f]█▄ █ ▀█▀    [head=2]Zaświadczenie o rozumności istoty[/head][/color]
    {"[color=#665f1f]█ ▀█   █     [head=3]Sector: :STATION: | BR-XXX[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"Niniejszym zaświadcza się, że przeprowadzone testy wykazały spełnianie kryteriów istoty rozumnej według wytycznych NanoTrasen."}
    {"[bold]- Rodzaj istoty:[/bold]"}
...
doc-text-printer-modernization-request = [color=#665f1f]█▄ █ ▀█▀    [head=2]Wniosek o przeprowadzenie modernizacji[/head][/color]
    {"[color=#665f1f]█ ▀█   █     [head=3]Sector: :STATION: | XXX-INŻ[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"Lokalizacja docelowa: [Nazwa działu lub obiektu]"}
...
doc-text-printer-product-manufacturing-order = [color=#665f1f]█▄ █ ▀█▀    [head=2]Zamówienie na wykonanie produktu[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"Proszę o przygotowanie towarów przez dział: [Nazwa działu]"}
...
doc-text-printer-anomaly-study-report = [color=#665f1f]█▄ █ ▀█▀    [head=2]Raport z badania anomalii[/head][/color]
    {"[color=#665f1f]█ ▀█   █     [head=3]Sector: :STATION: | BR-DOW[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Typ anomalii:[/bold]"}
    {"- [bold]Lokalizacja wykrycia:[/bold]"}
...
doc-text-printer-specialist-training-request = [color=#665f1f]█▄ █ ▀█▀    [head=2]Wniosek o szkolenie specjalistyczne[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Imię i nazwisko kursanta:[/bold]"}
    {"- [bold]Position:[/bold]"}
    {"- [bold]Zakres szkolenia:[/bold]"}
...
doc-text-printer-object-classification-protocol = [color=#665f1f]█▄ █ ▀█▀    [head=2]Protokół klasyfikacji obiektu[/head][/color]
    {"[color=#665f1f]█ ▀█   █     [head=3]Sector: :STATION: | BR-OCH[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Identyfikator obiektu:[/bold]"}
    {"- [bold]Opis zewnętrzny:[/bold]"}
...
doc-text-printer-service-object-study-report = [color=#1b487e]█▄ █ ▀█▀    [head=2]Raport z badania obiektu[/head][/color]
    {"[color=#1b487e]█ ▀█   █     [head=3]Sector: :STATION: | SRW-XXX[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    ...
    {"Stwierdzone właściwości obiektu:"}
    {"[Tutaj wpisz działanie i cechy]"}
    {"[italic]Stamp here (opcjonalnie).[/italic]"}
    {"▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄"}
    {"▄▄  ▄▄   ▄▄▄▄     ▄▄▄▄▄▄         ▄▄"}
    {"[italic]Stamp here:[/italic]"}
...
doc-text-printer-service-order = [color=#1b487e]█▄ █ ▀█▀    [head=2]Zlecenie serwisowe[/head][/color]
    ...
    {"==============================================="}
    {"- [bold]Zleceniodawca:[/bold]"}
    {"- [bold]Opis problemu / zapotrzebowania:[/bold]"}
    {"- [bold]Lokalizacja:[/bold]"}
...
doc-text-printer-event-organization-request = [color=#1b487e]█▄ █ ▀█▀    [head=2]Wniosek o organizację wydarzenia[/head][/color]
    {"[color=#1b487e]█ ▀█   █     [head=3]Sector: :STATION: | SRW-DOW[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Nazwa wydarzenia:[/bold]"}
    {"- [bold]Planowana data i lokalizacja:[/bold]"}
...
doc-text-printer-catering-status-report = [color=#1b487e]█▄ █ ▀█▀    [head=2]Raport stanu zaplecza gastronomicznego[/head][/color]
    ...
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Dostępne pozycje menu:[/bold]"}
    {"- [bold]Stan zapasów żywności:[/bold]"}
...
doc-text-printer-room-reservation = [color=#1b487e]█▄ █ ▀█▀    [head=2]Rezerwacja pomieszczenia[/head][/color]
    {"[color=#1b487e]█ ▀█   █     [head=3]Sector: :STATION: | SRW-SRW[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Rezerwowane pomieszczenie:[/bold]"}
...
doc-text-printer-centcom-universal = [color=#088723]╔══════════════════╗[/color]
    ...
    {"[color=#088723]║░░░░██░░░████░███░║[/color]   [head=3]Station :STATION: | CD-XX[/head]"}
    {"[color=#088723]╚══════════════════╝[/color]"}
    {"==============================================="}
    ...
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] Central Command Operator"}
    {"==============================================="}
    {"Szanowni Państwo,"}
...
doc-text-printer-centcom-staff-order = [color=#088723]╔══════════════════╗[/color]
    ...
    {"[color=#088723]║░░░░██░░░████░███░║[/color]   [head=3]Station :STATION: | CD-DOW[/head]"}
    {"[color=#088723]╚══════════════════╝[/color]"}
    {"==============================================="}
    ...
    {"[bold]Position:[/bold] Central Command Operator"}
    {"==============================================="}
    {"Szanowne Dowództwo stacji,"}
    {"W imieniu Sektorowego Sztabu Centralnego Dowództwa przekazuję następujące polecenie:"}
    {"<Treść polecenia>"}
...
doc-text-printer-centcom-periodic-reports-order = [color=#088723]╔══════════════════╗[/color]
    ...
    {"[bold]Position:[/bold] Central Command Operator"}
    {"==============================================="}
    {"Informujemy, że w ramach standaryzacji dokumentacji wprowadza się obowiązek sporządzania raportu:"}
    {"[bold]Kod:[/bold] <np. NT-DOW-07>"}
...
doc-text-printer-ia-verification-request = [color=#7a5c1a]█▄ █ ▀█▀    [head=2]Wniosek o weryfikację SPO[/head][/color]
    {"[color=#7a5c1a]█ ▀█   █     [head=3]Sector: :STATION: | ASW-DOW[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Przedmiot weryfikacji:[/bold]"}
    {"- [bold]Dotknięte działy:[/bold]"}
...
doc-text-printer-ia-documentation-request = [color=#7a5c1a]█▄ █ ▀█▀    [head=2]Wniosek o udostępnienie dokumentacji[/head][/color]
    {"[color=#7a5c1a]█ ▀█   █     [head=3]Sector: :STATION: | ASW-XXX[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"Ja, <Imię i nazwisko>, w charakterze Agenta Spraw Wewnętrznych, wnoszę o niezwłoczne przekazanie do wglądu następujących dokumentów:"}
    {"1."}
    {"2."}
    {"3."}
...
doc-text-printer-ia-department-audit-report = [color=#7a5c1a]█▄ █ ▀█▀    [head=2]Raport z kontroli działu[/head][/color]
    {"[color=#7a5c1a]█ ▀█   █     [head=3]Sector: :STATION: | ASW-CD[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Kontrolowany dział:[/bold]"}
    {"- [bold]Zakres kontroli:[/bold]"}
    {"- [bold]Stwierdzone nieprawidłowości:[/bold]"}
...
doc-text-printer-ia-interrogation-protocol = [color=#7a5c1a]█▄ █ ▀█▀    [head=2]Protokół przesłuchania inspekcyjnego[/head][/color]
    {"[color=#7a5c1a]█ ▀█   █     [head=3]Sector: :STATION: | ASW-OCH[/head][/color]"}
    {"==============================================="}
    {"[bold]Date:[/bold] :DATE:"}
    {"[bold]Author:[/bold] :NAME:"}
    {"[bold]Position:[/bold] :JOB:"}
    {"==============================================="}
    {"- [bold]Przesłuchiwany:[/bold]"}
    {"- [bold]Powód przesłuchania:[/bold]"}
    {"- [bold]Obecni świadkowie:[/bold]"}
...
doc-text-printer-syndicate-cooperation-offer = [color=#1b67a5]      ░▒▓███████▓▒░ [head=2]Oferta współpracy[/head][/color]
    {"[color=#1b67a5]░▒▓█▓▒░       [head=3]Sector: :STATION:[/head][/color]"}
    {"[color=#1b67a5]░▒▓█▓▒░[/color]"}
    {"[color=#1b67a5] ░▒▓██████▓▒░[/color]"}
    {"[color=#1b67a5]      ░▒▓█▓▒░[/color]"}
    {"[color=#1b67a5]      ░▒▓█▓▒░[/color]"}
...
doc-text-printer-syndicate-summons = [color=#1b67a5]      ░▒▓███████▓▒░ [head=2]Wezwanie do porozumienia[/head][/color]
    ...
    {"[bold]Date:[/bold] :DATE:"}
    {"==============================================="}
    {"Niniejszym informujemy, że <opis sytuacji>."}
