...
ent-BaseUplinkRadio10TC = { ent-BaseUplinkRadio }
    .suffix = 10 TC
    .desc = { ent-BaseUplinkRadio.desc }
ent-BaseUplinkRadio5TC = { ent-BaseUplinkRadio }
    .suffix = 5 TC
    .desc = { ent-BaseUplinkRadio.desc }
ent-BaseUplinkRadio7TCNukeOps = { ent-BaseUplinkRadioNukeopsReinforcement }
    .suffix = 7 TC, Nukeops Reinforcement
