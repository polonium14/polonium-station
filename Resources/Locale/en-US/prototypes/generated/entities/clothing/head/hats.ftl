...
ent-ClothingHeadHatBeretSecurity = security beret
    .desc = A corporate beret with an officer's rank emblem. A stylish clothing option for security officers.
...
ent-ClothingHeadHatBeretHoS = head of security's beret
    .desc = A white beret with a commander's rank emblem.
ent-ClothingHeadHatBeretWarden = warden's beret
    .desc = A corporate red beret with a warden's rank emblem. For officers that are more inclined towards style than safety.
...
ent-ClothingHeadHatHoshat = head of security's hat
    .desc = The standard-issue cap of the Head of Security. For showing the officers who's in charge.
...
ent-ClothingHeadHatWarden = warden's hat
    .desc = The warden's hat. This hat emphasizes that you are THE LAW
