...
ent-ClothingOuterHardsuitGoliath = goliath hardsuit
    .desc = A bulky hardsuit, adorned with a patchwork of thick, chitinous goliath hide.
...
ent-ClothingOuterHardsuitSecurityRed = head of security's hardsuit
    .desc = A special suit that protects against hazardous, low pressure environments. Has an additional layer of armor.
ent-ClothingOuterHardsuitLuxury = quartermaster's luxury hardsuit
    .desc = A high quality custom ordered hardsuit, fashioned after the Quartermaster's colors.
...
ent-ClothingOuterHardsuitSyndieElite = syndicate aramid hardsuit
    .desc = An alternative model of the blood-red hardsuit, with improved fireproofing. Property of Gorlex Marauders.
