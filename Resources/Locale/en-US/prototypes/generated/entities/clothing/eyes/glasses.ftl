...
ent-ClothingEyesGlassesMeson = meson goggles
    .desc = Green-tinted goggles using a proprietary polymer that provides protection from flying debris and sparks, alongside containing an integrated t-ray projector and scanner.
