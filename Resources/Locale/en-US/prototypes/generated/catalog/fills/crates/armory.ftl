...
ent-CrateTrackingImplants = tracking implants
    .desc = Contains a handful of tracking implanters.
...
ent-CrateSecurityRiot = riot gear crate
    .desc = Contains two sets of riot armor, helmets, gas masks and shields as well as four tear gas grenades, Requires Armory access to open.
