...
tips-dataset-157 = In crisis situations, performing CPR and using an epi-pen is an excellent way to keep someone from asphyxiating.
...
tips-dataset-168 = Felinids are slightly more susceptible to stamina damage than other species, so nightsticks take them down two hits faster than normal.
