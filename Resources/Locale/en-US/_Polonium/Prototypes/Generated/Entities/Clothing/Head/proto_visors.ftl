...
ent-ClothingHeadProtoVisoreHOS = HOS's Cybernetic Visor
    .desc = Highly specialized equipment used for providing additional data about the environment and causing the user permanent vision problems. This version has all the gadgets a HOS might want: Space protection, security HUDs AND some very poorly working NVG sensors.
